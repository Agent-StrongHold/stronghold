...
- **April 2026** — Project Touring begins. Thesis: the seven tiers are already an autonoetic gradient; what's missing is the *self* as a first-class indexed entity, and the Conduit is the right layer to carry it.
