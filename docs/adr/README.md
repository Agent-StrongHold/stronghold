...
| [006](ADR-K8S-006-runtime-okd.md) | Runtime selection: OKD single-node OpenShift | OKD SNO is the development reference runtime; the chart is OpenShift-first (Routes, SCCs, OperatorHub) with a vanilla-k8s fallback values file. |
