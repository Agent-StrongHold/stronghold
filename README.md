...
- **1000Hz proactive Reactor** — Event-driven agent runtime with typed trigger modes (event, interval, time, state) and per-trigger circuit breakers. No comparable system found in frameworks or in our literature review.
