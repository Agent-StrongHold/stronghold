...
class SessionCookieMiddleware:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        signing_key = container.config.jwt_secret or container.config.router_api_key
        ...
        # The PasswordSessionAuthProvider in the composite chain will decode it
...
DemoCookieMiddleware = SessionCookieMiddleware
